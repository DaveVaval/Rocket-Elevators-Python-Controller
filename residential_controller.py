...
class Elevator:
    def __init__(self, id, status, amountOfFloors, currentFloor):
        ...
        for number in range(self.amountOfFloors):
            ...
            self.floorRequestButtonsList.append(floorButton)
            floorNumber += 1
            floorRequestButtonID += 1
...
def Scenario1():
    ...
    print('Elevator A is sent to floor:', column.elevatorsList[0].currentFloor)
    print('User enters the elevator and presses of floor 7')
    elevator.requestFloor(7)
    print('...')
    print('User reaches floor', column.elevatorsList[0].currentFloor, 'and gets out')
...
def Scenario3():
    ...
    print('Elevator B is sent to floor:', column.elevatorsList[1].currentFloor)
    print('User enters the elevator and presses of floor 3')
